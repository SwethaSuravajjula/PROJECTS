<template>
    <div v-if="role ==='admin'">
      <h4>Welcome {{user}} !</h4>
        ...
        <h3>You are about to delete the section,are you sure about it</h3>
        <button @click="deleteSection" class="button">Delete</button>
...
export default {
    ...
    methods: {
        deleteSection() {
            axios.delete(`${API_BASE_URL}/admin/sections/${this.sectionId}`, { // this is to check whether the user is trying to access the admin page
                headers: {
