<template>
    <div v-if="role === 'admin'">
      ...
      <form @submit.prevent="createSection">
        ...
        <button type="submit" class="button">Create Section</button>
      </form>
  ...
  export default {
    ...
    methods: {
      createSection() {  //creates the section
        axios.post(`${API_BASE_URL}/admin/sections`, {
          name: this.name,
        ...
        .then(response => {
          ...
          this.$router.push('/sections');  // we can view the new section created inside sections page 
        })
        .catch(error => {
